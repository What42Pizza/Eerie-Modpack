...
const int sunriseStart = 22100;
const int sunriseEnd = 1500;
const int sunsetStart = 11250;
const int sunsetEnd = 13500;
...
const vec3 blockLight = vec3(1.0 , 0.4, 0.1) * 1.0;
...
const float dstrtAmount1 = -0.05;   // saturation
const float dstrtAmount2 = 0.4;   // contrast
const float dstrtAmount3 = -0.2;  // gamma?
const float fogStart = 0.3;
const float fogCurve = 1.5;  // higher means closer
const float glColorSaturation = 0.95;
const vec3  glColorTint = vec3(0.95, 0.95, 1.1);
